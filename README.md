...
A full-stack e-commerce application with a React frontend and ASP.NET Core backend. Features include product browsing, shopping cart management, user authentication, and Stripe payment integration.
